...
def draw_1():
    ...
    turtle.goto(-250, 0)
    turtle.color('red')
    write = turtle.write('同志们，请继续努力', font=('宋体', 60, 'normal'))
    time.sleep(2)
...
def draw_3():
    ...
    turtle.goto(-220, 50)
    turtle.color('red')
    write = turtle.write('💕好好', font=('宋体', 60, 'normal'))
    turtle.penup()
    turtle.goto(0, -50)
    write = turtle.write('学习💕', font=('宋体', 60, 'normal'))
    time.sleep(2)
...
def draw_4():
    ...
    turtle.color('blue')
    turtle.pendown()
    turtle.write('zzz      yyy', font=('wisdom', 50, 'normal'))
    turtle.speed(1)
    turtle.penup()
    turtle.color("red")
    turtle.goto(-31, -200)
